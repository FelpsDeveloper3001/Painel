...
config=config_1
if config == '1': exec(get('https://raw.githubusercontent.com/FelpsDeveloper3001/Painel3/main/source/src/menuTerminal.py').text)
elif config == '2': exec(get('https://raw.githubusercontent.com/FelpsDeveloper3001/Painel3/main/source/src/menuTouch.py').text)
